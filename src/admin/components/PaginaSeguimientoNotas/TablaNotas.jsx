export default function TablaNotas({ notas }) {
  const eliminarNota = (index) => {
    const confirmacion = window.confirm("¿Estás seguro de que deseas eliminar esta nota?");
    if (!confirmacion) return;

    // Aquí podrías implementar lógica para eliminar desde la API si lo deseas
    alert("Función de eliminar aún no conectada con la API.");
  };
